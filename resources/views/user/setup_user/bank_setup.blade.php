...
<form action="{{route('bank_setup.store')}}" id="form_data" method="POST">
@csrf
      ...
      <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
          <div class="text-gray-600 mb-2 text-center">
            <p class="font-medium text-lg">ব্যাংক সেটাপ</p>
          </div>
          ...
          <div class="lg:col-span-2">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div class="md:col-span-3">
                ...
                <input type="text" name="bank_name" id="bank_name" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" required/>
              ...
              <div class="md:col-span-2">
                ...
                <input type="text" name="account_name" id="account_name" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" required/>
              ...
              <div class="md:col-span-3">
                ...
                <input type="text" name="account_no" id="account_no" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" required/>
              ...
              <div class="md:col-span-2">
                ...
                <input type="text" name="shakha" id="shakha" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" required/>
