...
<form action="{{route('ponno_marka_setup.store')}}" id="form_data" method="POST">
@csrf
          ...
          <div class="lg:col-span-2">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              <div class="md:col-span-3">
                ...
                <input type="text" name="ponno_marka" id="ponno_marka" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" required/>
    ...
    function loadCurrentData()
    {
      $(function () {
        ...
        var table = $('.data-table').DataTable({
            ...
            ajax: "{{ route('ponno_marka_setup.index') }}",
            columns: [
                {data: 'sl', name: 'sl'},
