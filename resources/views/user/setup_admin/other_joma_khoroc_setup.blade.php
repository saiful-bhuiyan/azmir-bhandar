...
<form action="{{ isset($data) ? route('other_joma_khoroc_setup.update',$data->id) : '' }}" id="form_data" method="POST">
@csrf
@method('PUT')
      ...
      <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
          <div class="text-gray-600 mb-2 text-center">
            <p class="font-medium text-lg">অন্যান্য জমা খরচ সেটাপ</p>
          </div>
          ...
          <div class="lg:col-span-2">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              <div class="md:col-span-2">
                <label for="name">খাতের নাম :</label>
...
<script type="text/javascript">
    function loadCurrentData()
    {
      $(function () {
        ...
        var table = $('.data-table').DataTable({
            ...
            ajax: "{{ route('other_joma_khoroc_setup.admin') }}",
            columns: [
                {data: 'sl', name: 'sl'},
                {data: 'name', name: 'name'},
    ...
    function otherJomaKhorocSetupStatusChange(id)
    {
      if(id > 0)
      {
        ...
        $.ajax({
          ...
          url : '{{url("otherJomaKhorocSetupStatusChange")}}/'+id,
          type : 'GET',
