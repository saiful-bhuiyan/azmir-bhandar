...
<form action="{{ isset($data) ? route('mohajon_setup.update',$data->id) : '' }}" id="form_data" method="POST">
@csrf
@method('PUT')
      ...
      <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
          <div class="text-gray-600 mb-2 text-center">
            <p class="font-medium text-lg">মহাজন সেটাপ এডমিন</p>
          </div>
          ...
          <div class="lg:col-span-2">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div class="md:col-span-3">
                ...
                <input type="text" name="mobile" id="mobile" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ isset($data) ? $data->mobile : '' }}" />
              ...
              <div class="md:col-span-2">
                ...
                <input type="text" name="area" id="area" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ isset($data) ? $data->area : '' }}"  required/>
                @if($errors->has('area'))
              ...
              <div class="md:col-span-3">
                <label for="old_amount">সাবেক দেনা :</label>
                <input type="text" name="old_amount" id="old_amount" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="{{ isset($data) ? $data->old_amount : '' }}"  />
...
<script type="text/javascript">
    function loadCurrentData()
    {
      $(function () {
        ...
        var table = $('.data-table').DataTable({
            ...
            ajax: "{{ route('mohajon_setup.admin') }}",
            columns: [
                {data: 'sl', name: 'sl'},
                {data: 'name', name: 'name'},
    ...
    function mohajonSetupStatusChange(id)
    {
      if(id > 0)
      {
