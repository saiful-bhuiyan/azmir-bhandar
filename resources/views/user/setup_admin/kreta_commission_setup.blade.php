...
<form action="{{route('kreta_commission_setup.store')}}" id="form_data" method="POST">
@csrf
      ...
      <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
          <div class="text-gray-600 mb-2 text-center">
            <p class="font-medium text-lg">ক্রেতা কমিশন সেটাপ</p>
          </div>
          ...
          <div class="lg:col-span-2">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div class="md:col-span-2">
                <label for="commission_amount">ক্রেতা কমিশন :</label>
    ...
    function loadCurrentData()
    {
      $(function () {
        ...
        var table = $('.data-table').DataTable({
            ...
            ajax: "{{ route('kreta_commission_setup.index') }}",
            columns: [
                {data: 'sl', name: 'sl'},
