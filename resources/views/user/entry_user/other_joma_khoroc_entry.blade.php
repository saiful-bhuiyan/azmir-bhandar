...
<form action="{{route('other_joma_khoroc_entry.store')}}" id="form_data" method="POST">
@csrf
      ...
      <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
          <div class="text-gray-600 mb-2 text-center">
            <p class="font-medium text-lg">অন্যান্য জমা/খরচ</p>
          </div>
    ...
    function loadCurrentData()
    {
      $(function () {
        ...
        var table = $('.data-table').DataTable({
            ...
            ajax: "{{ route('other_joma_khoroc_entry.index') }}",
            columns: [
                {data: 'sl', name: 'sl'},
                {data: 'type', name: 'type'},
                {data: 'name', name: 'name'},
