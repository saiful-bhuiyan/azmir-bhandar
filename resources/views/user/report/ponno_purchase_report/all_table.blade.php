...
<tbody id="table_body">
    ...
    <tr class="border border-collapse">
        <td class="px-6 py-3 font-bold text-blue-700"><a href="{{route('ponno_purchase_report.memo',$p->id)}}">{{$count++}}</a></td>
        <td class="px-6 py-3">@if($p->purchase_type == 1) নিজ খরিদ @elseif($p->purchase_type == 2) কমিশন @endif</td>
