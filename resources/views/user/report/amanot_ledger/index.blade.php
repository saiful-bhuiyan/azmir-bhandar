      ...
      <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
          <div class="text-gray-600 mb-2 text-center">
            <p class="font-medium text-lg">আমানত লেজার</p>
          </div>
          ...
          <div class="lg:col-span-2">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
              ...
              <div class="md:col-span-2">
                ...
                <select name="address" id="address" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" onchange=" getAmanotNameByAddress();" required>
...
function search()
  {
    var amanot_setup_id = $('#amanot_setup_id').val();
    ...
    if(amanot_setup_id != "")
    {
      $.ajax({
      type : 'POST',
      url : "{{route('amanot_ledger.search')}}",
      data :  {
        amanot_setup_id : amanot_setup_id,
        date_from : date_from,
        date_to : date_to
      },
    ...
    {
      swal("দয়া করে আমানতের নাম সিলেক্ট করুন")
    }
    
  }


    function getAmanotNameByAddress()
    {
