...
<div class="container mx-auto max-w-screen ">
    <div class="p-4 px-4 mb-6 text-center bg-white md:p-8">
      <span class="p-1 text-white bg-blue-600">হাওলাত লেজার</span>
    ...
    <p class="text-xl uppercase w-[90%] py-3 font-bold text-center pl-4 barlow text-green-800">হাওলাত লেজার</p>
        <div class="grid grid-cols-2 mt-2 text-center px-4">
        @if($hawlat_setup)
            <div class="col-span-1 py-1">
                <h1 class="text-base font-bold text-red-600">হাওলাতকারীর নাম : {{$hawlat_setup->name}}</h1>
            </div>
            <div class="col-span-1 py-1">
                <h1 class="text-base font-bold text-red-600">হাওলাতকারীর ঠিকানা : {{$hawlat_setup->address}}</h1>
            </div>
            <div class="col-span-1 py-1">
                <h1 class="text-base font-bold text-red-600">হাওলাতকারীর মোবাইল : {{$hawlat_setup->mobile}}</h1>
            </div>
        </div>
        @endif
