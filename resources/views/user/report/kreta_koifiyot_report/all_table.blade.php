    ...
    <p class="text-xl uppercase w-[90%] py-3 font-bold text-center pl-4 barlow text-green-800">ক্রেতার কৈফিয়ত রিপোর্ট</p>
        ...
        @if($kreta_setup)
            <div class="col-span-1 py-1">
                <h1 class="text-base font-bold text-red-600">হাওলাতকারীর নাম : {{$kreta_setup->name}}</h1>
            </div>
            <div class="col-span-1 py-1">
                <h1 class="text-base font-bold text-red-600">হাওলাতকারীর ঠিকানা : {{$kreta_setup->address}}</h1>
            </div>
            <div class="col-span-1 py-1">
                <h1 class="text-base font-bold text-red-600">হাওলাতকারীর মোবাইল : {{$kreta_setup->mobile}}</h1>
            </div>
        </div>
        @endif
