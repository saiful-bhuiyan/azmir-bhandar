...
class KretaSetupController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('user.setup_admin.kreta_setup',compact('data'));
    }
    ...
    public function admin(Request $request)
    {
         if ($request->ajax()) {
            ...
            ->addColumn('action',function($v){
                ...
                return '<div class="flex gap-x-2">
                    <a href="'.route('kreta_setup.edit', $v->id).'" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">ইডিট</a>

                    <form method="post" action="'.route('kreta_setup.destroy',$v->id).'" id="deleteForm">
                    '.csrf_field().'
                    '.method_field('DELETE').'
        ...
        return view('user.setup_admin.kreta_setup');
    }
}
